...
import com.example.usedbookmarket.adapter.BooksYouLikeListAdapter
import com.example.usedbookmarket.model.Book

class BooksYouLikeActivity: AppCompatActivity() {
    private lateinit var adapter: BooksYouLikeListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = BooksYouLikeListAdapter(clickListener = {
